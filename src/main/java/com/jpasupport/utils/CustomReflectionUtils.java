...
//		});
	...
	public static void setFieldValue(Object srcObj, Object trgtObj) {
		Map<String, String> linkFieldMap = CustomReflectionUtils.getLinkEntityFieldNames(trgtObj.getClass(), srcObj.getClass());
		Map<String, String> fieldMap = CustomReflectionUtils.getFKFieldNames(trgtObj.getClass(), srcObj.getClass());
		Field srcFld = null;
		Field trgtFld = null;
	...
	public static void main(String[] args) throws NoSuchFieldException, SecurityException {
		...
		//getFieldNames(CustomReflectionUtils.class);
